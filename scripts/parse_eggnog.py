...
def main():
    parser = argparse.ArgumentParser(description="Generate table of counts and a plot for eggNOG annotation file.")
    parser.add_argument("eggnog_file", help="Path to eggNOG annotation file")
    parser.add_argument("output_dir", help="Directory to save the outputs (counts table and plot)")
