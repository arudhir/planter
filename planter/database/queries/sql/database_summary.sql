SELECT 
    ...
    COUNT(DISTINCT gpm.gene_seqhash_id) as total_genes,
    COUNT(DISTINCT CASE WHEN expr.gene_seqhash_id IS NOT NULL THEN gpm.protein_seqhash_id END) as sequences_with_expression,
    ...
    CASE WHEN COUNT(expr.gene_seqhash_id) > 0 
